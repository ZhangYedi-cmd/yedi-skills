...
| 角色 | 色值 | 用途 |
|------|------|------|
| 纸张主色 | **#F5EED8** 暖米白, #FAF5EC 极淡米 | 背景（v3.0 升级：比旧版更亮更干净） |
...
> **v3.0 关键更新**：背景从旧版 #F0E0C0~#E8D5B0（偏深旧）升级为 #F5EED8~#FAF5EC（更亮更干净）。
> 同时**大幅简化纸张做旧**：不再使用折痕、污渍、撕边，只保留微妙纸纹。
...
### traditional-encyclopedia（v3.0 升级版）
```
Color energy: WARM. Background: clean warm cream (#F5EED8~#FAF5EC), subtle
paper grain only — NO fold marks, NO age spots, NO dark stains.
Ink: deep sepia brown (#3A2A1A). Accents: BOLD cinnabar red (#C0392B) for stamps
and keyword tags, BRIGHT amber gold (#FFBF00) for knowledge frames. Natural
subjects (plants, animals, costumes) use RICHER, MORE SATURATED colors as
