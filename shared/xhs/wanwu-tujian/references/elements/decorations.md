...
| 封面角标 | 左上+右上 | 如"图鉴"+对应主题 | `two red square corner stamps with Chinese characters` |
...
| 宣纸折痕 | `subtle paper fold marks on rice paper` |

## 纸张质感
| 元素 | Prompt 关键词 |
|------|--------------|
| 折痕 | `subtle paper fold marks` |
| 污渍 | `age spots and faint stains on old paper` |
| 磨损边 | `worn and slightly torn edges` |
| 泛黄 | `yellowed aged Chinese paper, matte finish` |
...
- group-portrait: 标注线 + 多标本排列 + 角标印章 + 水墨山水边角
- center-radial: 知识块叠层 + ✓✗对比场景 + 步骤框 + 工具图解 + 角标印章
- infographic: 编号步骤 ①②③ + 箭头流程 + 场景小图
- scattered-icons: 概念图标散布 + 角标印章 + 金句框
- grid-collage: 九宫格知识卡片 + 分类标签 + 统一边框
