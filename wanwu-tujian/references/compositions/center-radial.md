...
| 风格变体 | 适配调整 |
|---------|---------|
| **cartoon-infographic** | 中央→Q版主角色（主题色服装+光环）；辐射子元素→成就徽章+漫画格；知识区→雷达图+标签云+金句框；信息密度 EXTREME |
| **celestial-narrative** | 中央→仙人/圣贤场景（飘逸长袍+金光）；子概念→神圣光晕中的知识框；背景→天界渐变+云海；底部→智慧金句框 |
